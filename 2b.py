# -*- coding: utf-8 -*-
"""MLProjectExercises2b.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xv8423-1WXgeKHiVqaL0Gjpcuq5dhzpz
"""
...
class PolinomialRegression:
    def __init__(self, x, y, degree,lmdb, learning_rate=0.001):
    ...
    def _loss(self, x, y):
        ...
        l2_reg = self.lmdb * tf.reduce_mean(tf.square(self.w))
...
print(predictions)
lmdb_arr = [0,0.001,0.01,0.1,1,10,100]

for lmdb in lmdb_arr:
    poly_reg = PolinomialRegression(xs, ys, degree,lmdb)
    poly_reg.fit()
...
def plot_data(x, y, predictions):
    colors=["red","blue","green","yellow","brown","purple","gray"]
...
def plot_costs(costs):
  lmdb_arr = [0,0.001,0.01,0.1,1,10,100]
  plt.plot(lmdb_arr,costs)
  plt.xlabel('lmdb')
  plt.ylabel('costs')
  plt.show()


def plot_costs1(lmdb_arr,costs):
  plt.plot(lmdb_arr,costs)
  plt.xlabel('lmdb')
  plt.ylabel('costs')
  plt.show()
...
lmdb_arr = [0,0.001,0.01,0.1,1,10,100]
print(lmdb_arr)
print([i.numpy() for i in all_costs])
plot_costs1(lmdb_arr[0:4],all_costs[0:4])
plot_costs1(lmdb_arr[3:],all_costs[3:])
plot_costs(all_costs)

#kada je lambda 0, tj kad nemamo regularizaciju dajem nam najbolje rezultate jer su podaci rasporedjeni kao funkcija treceg stepena, pa nema potrebe raditi
#regularizaciju te funkcije